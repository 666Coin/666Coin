...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "666Coin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"107.170.152.5", "107.170.152.5"},
    {"188.226.159.41", "188.226.159.41"},
    {"128.199.209.80", "128.199.209.80"},
...
unsigned int pnSeed[] =
{ 0x0598aa6b, 0x299fe2bc, 0x50d1c780, 0x1708795b };
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. 666Coin is probably already running."), addrBind.ToString().c_str());
        else
