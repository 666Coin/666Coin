...
unsigned int nStakeTargetSpacing = 666;			// 666 sec block spacing

int64 nChainStartTime = 1398972112;
...
static const int CUTOFF_HEIGHT = 43800;    // Height at the end of one year

// miner's coin base reward based on nBits
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	int64 nSubsidy = 66600000;
...
const int YEARLY_BLOCKCOUNT = 43800;	// 365 * 120
...
static const int64 nTargetTimespan = 666 * 10;  
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in 666Coin
    bool fStrictPayToScriptHash = true; // Always active in 666Coin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "666Coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "666Coin - The Devil's answer";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x8007cb0735f417811bed1c51a1f7076b784facd08d3f3a0c06b98c97eea94854"));
...
unsigned char pchMessageStart[4] = { 0x06, 0x06, 0x06, 0x06 };
